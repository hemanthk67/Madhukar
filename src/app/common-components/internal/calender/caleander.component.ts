...
export class CalenderComponent implements OnInit {
  ...
  years = [
    { name: "1950-58", value: 1954 },
    { name: "1959-67", value: 1963 },
    { name: "1968-76", value: 1972 },
    { name: "1977-85", value: 1981 },
    { name: "1986-94", value: 1990 },
    { name: "1995-03", value: 1999 },
    { name: "2004-12", value: 2008 },
    { name: "2013-21", value: 2017 },
    { name: "2022-30", value: 2026 },
  ];
  year = [];
  dateInputNumber = {
    ...
    if (this.dateInput.year) {
      if (this.dateInput.month) {
        if (!this.dateInput.date) {
          ...
          this.dateEmit.emit(
            this.dateInputNumber.date +
              "/" +
              this.dateInputNumber.month +
              "/" +
              this.dateInputNumber.year
          );
        }
      } else {
