...
export class DocumentsService {
  ...
  enquiryOffer(
    ...
    d3.select("#pdf-preview").selectAll("*").remove();
    setTimeout(
      function () {
  ...
  offerpdfpreview(
    ...
    var customer = this.pdfPreviewPage1
      .append("div")
      .style("display", "flex")
    ...
    this.pdfPreviewPage1
      .append("div")
      .text(
        " We thank you for your enquiry and the interest shown in our product. In view of the same, we wish to furnish our brief techno- commercial offer as under for your kind consideration."
      )
      .style("margin-top", "10px")
      .style("padding", "0 10px");

    var items = this.pdfPreviewPage1
      .append("div")
      .style("margin-top", "10px")
      .style("display", "flex")
      .style("font-weight", "600");
    ...
    for (let i = 0; i < offer.terms.length; i++) {
      if (
        (d3.select("#pdf-preview") as any).node().getBoundingClientRect()
          .height >
        (d3.select("#pdf-preview-start") as any).node().getBoundingClientRect()
          .height +
          (d3.select("#pdf-preview-header") as any)
            .node()
            .getBoundingClientRect().height +
          130
      ) {
        item = this.pdfPreviewPage1
          .append("div")
          .style("display", "flex")
          .style("font-weight", "500")
          .style("font-size", "12px")
      ...
      if (content.node().getBoundingClientRect().height < 50) {
        content.style(
          "padding-top",
          (50 - content.node().getBoundingClientRect().height) / 2 + "px"
        );
      }
      term.style(
        "padding-top",
        (content.node().getBoundingClientRect().height - 12) / 2 + "px"
      );
      sno.style(
        "padding-top",
        (content.node().getBoundingClientRect().height - 16) / 2 + "px"
      );
    }
  ...
  offerpdfpreview2(enquiry, customerReference, offer) {
    ...
    this.pdfPreviewPage2
      ...
      .style("margin-top", "15px")
      .text(
        "We shall be glad to furnish any further information (or) clarifications required by you and await your valued instructions, which will receive our most careful and prompt attention."
      );
    ...
    referenceLeft
      ...
      .style("margin-top", "10px")
      .style("font-weight", "600");
    referenceLeft.append("div").text("Cell: " + "9100920124");
    referenceLeft.append("div").text("Ph: " + offer.officeNumber);
    referenceLeft
      .append("div")
      .text("Email: ")
      .append("span")
    ...
    referenceRight
      ...
      .style("font-weight", "600");
    referenceRight.append("div").text(offer.signBy).style("font-weight", "600");
    referenceRight.append("div").text(offer.designation);
    referenceRight.append("div").text("Cell: " + offer.authorizedPhoneNumber);
    referenceRight
      .append("div")
      .text("Email: ")
      .append("span")
    ...
    var businessPartnersListadd = this.pdfPreviewPage2
      .append("div")
      .style("margin-top", "10px");
    businessPartnersListadd
      .append("div")
    ...
    var businessPartners = businessPartnersListadd
      .append("div")
    ...
    this.businessPartnersListArrangement(
      businessPartnersList,
      businessPartners,
      businessPartnersListadd
    );
    businessPartnersListadd = this.pdfPreviewPage2
      .append("div")
      .style("margin-top", "10px");
    businessPartnersListadd
      .append("div")
    ...
    this.solarBusinessPartnerListArrangement(
      solarBusinessPartnersList,
      businessPartners,
      businessPartnersListadd
    );
  ...
  businessPartnersListArrangement(
    businessPartnersList,
    businessPartners,
    businessPartnersListadd
  ) {
    for (let i = 0; i < businessPartnersList.length; i++) {
      var border = businessPartners
        ...
        .attr(
          "src",
          "./assets/logo/" + businessPartnersList[i].name + "Logo.png"
        )
        ...
        .on(
          ...
          function () {
            ...
            if (businessPartnersList.length !== 0) {
              businessPartners = businessPartnersListadd
                .append("div")
                .style("border-radius", "10px")
                .style("border", "solid 2px rgb(22, 58, 154)")
                .style("background-color", "#F9F9F9")
      ...
      if (
        ...
        i !== 17 &&
        i !== 23 &&
        i !== businessPartnersList.length - 1
      ) {
        businessPartners
          .append("svg")
          .attr("width", "3px")
  ...
  solarBusinessPartnerListArrangement(
    solarBusinessPartnersList,
    businessPartners,
    businessPartnersListadd
  ) {
    for (let i = 0; i < solarBusinessPartnersList.length; i++) {
      var border = businessPartners
        ...
        .attr(
          "src",
          "./assets/logo/" + solarBusinessPartnersList[i].name + "Logo.png"
        )
      ...
      if (
        ...
        i !== 7 &&
        i !== 11 &&
        i !== solarBusinessPartnersList.length - 1
      ) {
        businessPartners
          .append("svg")
          .attr("width", "3px")
